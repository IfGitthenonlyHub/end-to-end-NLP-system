...
TASK: Create {num} Question-Answer pairs based on the text provided.
...
REQUIREMENTS:
- Questions don't need to be short like answers, but answers must be concise (1-10 words).
...
if __name__ == "__main__":
    ...
    if all_qa:
        ...
        print(f"\nXONG! Đã tạo tổng cộng {len(all_qa)} câu hỏi.")